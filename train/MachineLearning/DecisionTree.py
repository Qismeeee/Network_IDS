...
def run_decision_tree(X_train, X_test, y_train, y_test):
    ...
    save_confusion_matrix(y_test, y_pred, "DecisionTree", save_dir)
    save_metrics_plot(y_test, y_pred, "DecisionTree", save_dir)

def main():
    root = 'preprocess/'  
    X_train_scaled, X_test_scaled, y_train_resampled, y_test = load_and_preprocess_data(root='data/')
    run_decision_tree(X_train_scaled, X_test_scaled, y_train_resampled, y_test)
